...
describe(' Tools Spec', function() {
	...
	it('Date List : Ends Mid day', function(done) {
	...
	it('Date List : Starts Mid Day ', function(done) {
		let expected = [{"start":"2017-01-01T13:00:00.000Z","end":"2017-01-01T23:59:59.999Z"},{"start":"2017-01-02T00:00:00.000Z","end":"2017-01-02T20:00:00.000Z"}];
		let res = datesToDateList({start:"2017-01-01T13:00:00.000Z",end:'2017-01-02T20:00:00.000Z'})
		expect(res).to.be.an('array').of.length(2)
		expect(JSON.stringify(res)).to.equal(JSON.stringify(expected))
		done();
	});
